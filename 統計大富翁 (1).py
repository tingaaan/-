            ...
            with c2:
                if st.session_state.last_dice:
                    ...
                    <div class='dice-container'>
                        <div class='dice-face'>{DICE_FACES[st.session_state.last_dice]}</div>
                        <div style='font-size:0.8rem; color:#c2185b; font-weight:700; margin-top:0.3rem;'>
                            擲出 {st.session_state.last_dice} 點！
                        </div>
                    ...
                    <div class='dice-container'>
                        ...
                        <div style='font-size:0.75rem; color:#aaa;'>等待擲骰</div>
                    </div>""", unsafe_allow_html=True)
